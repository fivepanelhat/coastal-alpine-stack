...
Do NOT open a public issue for any security flaws found in the Core. 
Report directly to the Chief Architect. Triage for Core vulnerabilities is immediate, and patching will follow strict Semantic Versioning to prevent edge-node desynchronization.
