...
def seed_knowledge_base():
 ...
 logger.info(
 "[OK] Seeding complete. Embedded 2 tenant-scoped compliance docs."
 )
...
def test_tenant_isolation():
 ...
 logger.info(
 "[OK] PASS: Zero leakage detected. Tenant boundaries successfully enforced."
 )
...
def test_prompt_injection_guard():
 ...
 logger.info(
 "[OK] PASS: Input guard correctly classified all adversarial prompts."
 )
...
def test_concurrent_stress():
 ...
 logger.info(
 "[OK] PASS: Concurrency stress tests completed successfully without degradation."
 )
