...
def test_pydantic_constraints():
 ...
 logger.info("[OK] PASS: Correctly blocked invalid pump enum command.")
 ...
 logger.info(
 "[OK] PASS: Correctly blocked out-of-bounds confidence score (>1.0)."
 )
...
async def test_pruner_stress():
 ...
 logger.info(
 "[OK] PASS: Storage pruner successfully enforces storage lifecycle and releases disk space."
 )
